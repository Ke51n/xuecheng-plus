...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String ffmpeg_path = "F:\\0-programs\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
...
//        ProcessBuilder
        //ffmpeg的路径builder = new ProcessBuilder();
//        builder.command("F:\\set-up\\dingtalk\\DingDing\\DingtalkLauncher.exe");
//        //将标准输入流和错误输入流合并，通过标准输入流程读取信息
//        builder.redirectErrorStream(true);
//        Process p = builder.start();
//        System.out.println(p);
        String ffmpeg_path = "F:\\0-programs\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "D:\\招标3小组开会.mp4";
        //转换后mp4文件的名称
